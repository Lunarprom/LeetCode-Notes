...
基友给我布置的刷题作业。这是一道比较高频的面试题（而且是Hard）。从它入手可以发散至少三个tag: sliding window, two sum and HashTable。
...
**我在思考的过程中觉得这道题的一大难点在于不知道什么时候能够缩小窗口的长度。**参考了一下YouTube上关于这道题的讲解视频获得了以下启发：
>General Idea:
